...
>[Upgrade to the Pro Version Now!&raquo;](https://wpbean.com/product/wpb-woocommerce-product-slider-pro)  |  [DEMO](http://demo1.wpbean.com/wpb-woocommerce-product-slider-pro/)  |  [Support](http://wpbean.com/support/) |  [Documentation](http://docs.wpbean.com/docs/wpb-woocommerce-products-slider-free-version/installing/)
...
= version 2.0.3 =
* It's a massive update. We rebuild this plugin. You have to change the shortcodes and widgets. Also settings need to updated. Please follow the new documentaion.
