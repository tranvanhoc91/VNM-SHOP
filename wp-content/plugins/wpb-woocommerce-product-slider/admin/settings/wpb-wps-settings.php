...
class wpb_wps_lite_settings {
    ...
    function admin_menu() {
        //add_options_page( __( 'WPB Woo Product Slider', WPB_WPS_TEXTDOMAIN ), __( 'WPB Woo Product Slider', WPB_WPS_TEXTDOMAIN ), 'delete_posts', 'wpb_woocommerce_product_slider', array($this, 'wpb_wps_plugin_page') );
